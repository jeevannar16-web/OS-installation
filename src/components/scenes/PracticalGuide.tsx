...
const ARCH_STEPS: GuideStep[] = [
  ...
  },
  {
    ...
    tip: "For Ventoy: just copy the ISO to the Ventoy partition.",
  },
  {
    title: "Boot from USB",
    description: "Restart, enter BIOS (F2/Del/F12), set USB as first boot device, save & exit.",
    kind: "info",
    tip: "Disable Secure Boot if the USB doesn't boot.",
  },
  {
    title: "Live Environment",
    description: "The USB boots into the Arch live environment. Kernel messages scroll by, then you land at a root shell prompt.",
    kind: "info",
    tip: "You are automatically logged in as root. No password needed.",
  },
  {
    title: "Connect to Network",
    description: "Use nmtui or iwctl to connect to WiFi. For Ethernet it's automatic.",
    kind: "gui",
    guiAction: "nmtui → Activate a connection → Select WiFi → Enter password → OK → Back → Quit",
    tip: "Run 'ping archlinux.org' to verify connectivity.",
  },
  {
    title: "Launch archinstall",
    description: "Run the guided installer. It handles partitioning, packages, users, and configuration through an interactive TUI menu.",
    kind: "gui",
    guiAction: "Type: archinstall → Press Enter",
  ...
  },
  {
    ...
    kind: "gui",
    guiAction: "Disk configuration → Best effort → Select drive → Filesystem: ext4 → Confirm",
    tip: "For dual-boot: choose your existing drive. archinstall will create partitions alongside Windows.",
  },
  {
    title: "Filesystem & Swap",
    description: "Confirm filesystem choice and set up swap (zram recommended).",
    kind: "gui",
    guiAction: "Disk configuration → Filesystem: ext4 → Swap: zram → Confirm",
  },
  {
    title: "Bootloader",
    ...
    tip: "Use systemd-boot for UEFI-only single-boot setups.",
  },
  {
    title: "Hostname & Root Password",
    description: "Set the machine name and root password.",
    kind: "gui",
    guiAction: "Hostname → archlinux → Root password → [set password] → Confirm → Back",
  },
  {
    title: "User Account",
    description: "Create your user account with sudo privileges.",
    kind: "gui",
    guiAction: "User account → Add user → [username] → [password] → Super user: Yes → Confirm → Back",
  },
  {
    title: "Desktop Environment",
    description: "Choose a desktop profile. KDE Plasma is recommended for a full-featured experience.",
    kind: "gui",
    guiAction: "Profile → Type: Desktop → KDE Plasma → Graphics: All open source → Audio: PipeWire → Back",
    tip: "GNOME is simpler. XFCE is lightweight for older hardware.",
  },
  {
  ...
  },
  {
    ...
    description: "Add extra packages like a web browser.",
    kind: "gui",
  ...
  },
  {
    ...
    description: "archinstall partitions the disk, downloads packages, configures the bootloader, and sets up the desktop environment.",
    kind: "info",
    tip: "This takes 5-15 minutes. Do NOT power off during installation.",
  },
  {
    title: "Reboot",
    description: "After installation completes, remove the USB and reboot into your new system.",
    kind: "info",
  ...
  },
  {
    ...
    kind: "info",
    tip: "If dual-booting, Windows will also appear in the GRUB menu.",
  },
  {
    title: "Login & Desktop",
    description: "The display manager shows a login screen. Enter your password and the desktop will start.",
    kind: "info",
    tip: "Run 'sudo pacman -Syu' after first login to update everything. Welcome to Arch Linux!",
  },
];
