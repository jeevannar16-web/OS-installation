...
const shortName = "Arch";
const osVersion = "Arch Linux (64-bit)";
const defaultMemoryMB = 2048;
const defaultDiskGB = 20;
const isoFilename = "archlinux-2024.07.01-x86_64.iso";
const isoSize = "1.1 GB";
const defaultEfi = true;

export default function ArchVM({ onDone }: { onDone?: () => void }) {
