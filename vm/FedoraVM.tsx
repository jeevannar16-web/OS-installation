...
const shortName = "Fedora";
const osVersion = "Fedora (64-bit)";
const defaultMemoryMB = 4096;
const defaultDiskGB = 25;
const isoFilename = "Fedora-Workstation-Live-x86_64-41.iso";
const isoSize = "2.4 GB";
const defaultEfi = false;

export default function FedoraVM({ onDone }: { onDone?: () => void }) {
