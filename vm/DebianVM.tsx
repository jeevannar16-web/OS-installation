...
const shortName = "Debian";
const osVersion = "Debian (64-bit)";
const defaultMemoryMB = 2048;
const defaultDiskGB = 20;
const isoFilename = "debian-12.7.0-amd64-netinst.iso";
const isoSize = "0.7 GB";
const defaultEfi = false;

export default function DebianVM({ onDone }: { onDone?: () => void }) {
